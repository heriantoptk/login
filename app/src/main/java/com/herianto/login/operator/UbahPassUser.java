...
public class UbahPassUser extends AppCompatActivity {

    ProgressDialog pDialog;
    ImageButton btn_back_ubah_pass;
    Button btn_submit_ubah_pass;
    EditText txt_password_ubah_pass, txt_passwordx_ubah_pass;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ubah_pass_user);
        ...
        txt_username = (TextView) findViewById(R.id.edt_email_ubah_pass);
        txt_fullname = (TextView) findViewById(R.id.edt_fullname_ubah_pass);
        btn_back_ubah_pass = (ImageButton) findViewById(R.id.btn_back_ubah_pass);
        ...
        txt_password_ubah_pass = (EditText) findViewById(R.id.edt_password_ubah_pass);
        txt_passwordx_ubah_pass = (EditText) findViewById(R.id.edt_passwordx_ubah_pass);
        btn_submit_ubah_pass = (Button) findViewById(R.id.btn_submit_ubah_pass);

        txt_username.setText(username);
        txt_fullname.setText(fullname);

        btn_back_ubah_pass.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent( UbahPassUser.this, Admin.class);
        ...
        btn_submit_ubah_pass.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {
                // TODO Auto-generated method stub
                String idpemakai = idregister;
                String password = txt_password_ubah_pass.getText().toString();
                String confirm_password = txt_passwordx_ubah_pass.getText().toString();
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        txt_password_ubah_pass.setText("");
                        txt_passwordx_ubah_pass.setText("");
